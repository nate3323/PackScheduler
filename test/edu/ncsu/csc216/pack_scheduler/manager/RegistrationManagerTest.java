...
/** 
 * Tests the RegistrationManagerTest
...
public class RegistrationManagerTest {
	...
	public void testLogin() {
		manager.clearData();
		manager.logout();
		manager.getStudentDirectory().addStudent("name", "lastname", "id", "email@email.com", "Regi5tr@r", "Regi5tr@r", 18);
		manager.getStudentDirectory().addStudent("test", "test", "test", "test@email.com", "Regi5tr@r", "Regi5tr@r", 18);
		assertTrue(manager.login("id", "Regi5tr@r"));
		assertFalse(manager.login("test", "Regi5tr@r"));
		
		manager.logout();
		
		manager.getStudentDirectory().addStudent("name", "lastname", "registrar", "email@email.com", "Regi5tr@r", "Regi5tr@r", 18);
		assertTrue(manager.login("registrar", "Regi5tr@r"));
		manager.logout();
		assertFalse(manager.login("registrar", "@r"));
	}
	...
	public void testLogout() {
		...
		manager.getStudentDirectory().addStudent("name", "lastname", "id", "email@email.com", "Regi5tr@r", "Regi5tr@r", 18);
		assertTrue(manager.login("id", "Regi5tr@r"));
		Student s = new Student ("Wolf", "Scheduler", "id", "registrar@ncsu.edu", "Regi5tr@r");
	...
	public void testGetCurrentUser() {
		...
		Student s = new Student ("Wolf", "Scheduler", "registrar", "registrar@ncsu.edu", "Regi5tr@r");
		assertEquals(s.getId(), manager.getCurrentUser().getId());
	}
	 ...
	 */
	@Test
	public void addFacultyToCourseTest() {
	    ...
	    //tests for when user is null
	    assertFalse(manager.addFacultyToCourse(catalog.getCourseFromCatalog("CSC116", "001"), directory.getFacultyById("awitt")));
	    
	    manager.login("registrar", "Regi5tr@r");
	    
	    catalog.addCourseToCatalog("CSC323", "title", "001", 3, null, 10, "MW", 1130, 1230);
	    
	    assertTrue(manager.addFacultyToCourse(catalog.getCourseFromCatalog("CSC323", "001"), directory.getFacultyById("awitt")));
	 ...
	 */
	@Test
	public void removeFacultyFromCourse() {
		FacultyDirectory directory = manager.getFacultyDirectory();
	    directory.loadFacultyFromFile("test-files/faculty_records.txt");
	    CourseCatalog catalog = manager.getCourseCatalog();
	    catalog.loadCoursesFromFile("test-files/course_records.txt");
	    ...
	    //tests for when user is null
	    assertFalse(manager.removeFacultyFromCourse(catalog.getCourseFromCatalog("CSC116", "001"), directory.getFacultyById("awitt")));
	    
	    manager.login("registrar", "Regi5tr@r");
	    
	    catalog.addCourseToCatalog("CSC323", "title", "001", 3, null, 10, "MW", 1130, 1230);
	    manager.addFacultyToCourse(catalog.getCourseFromCatalog("CSC323", "001"), directory.getFacultyById("awitt"));
	    
	    assertTrue(manager.removeFacultyFromCourse(catalog.getCourseFromCatalog("CSC323", "001"), directory.getFacultyById("awitt")));
