...
public class CourseTest {
	...
	public void testIsDuplicate() {
		...
		Course c3 = new Course("CSC111", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CAP, MEETING_DAYS, START_TIME, END_TIME);
	...
	public void testCompareTo() {
		Course c1 = new Course("CSC216", "Java", "001", 4, "id", CAP, "MWF", 900, 1000);
		Course c2 = new Course("CSC216", "Java", "001", 4, "id", CAP, "MWF", 900, 1000);
		Course c3 = new Course("CSC216", "Java", "002", 4, "id", CAP, "MWF", 900, 1000);
		Course c4 = new Course("AC101", "Basic Accouning", "001", 4, "id", CAP, "MWF", 900, 1000);
		...
		//Test null
				...
				//Test same name but different section
